...
userRoute.get("/userlogout", usercontroller.logout)
...
userRoute.post("/changepassword", auth.isLogout, usercontroller.changepassword)
...
userRoute.post("/addtocart", wishcontroller.addtocart)
...
userRoute.post('/verify-payment', auth.isLogout, ordercontroller.PaymentVerified)
